  ...
  return (
    <div>
      ...
      <section className="bg-gray-200 text-center py-20">
        <h1 className="text-4xl font-bold mb-4">Dhaabbata Leenjii konkolaachistootaa sabaa ifii</h1>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="border rounded-lg p-6 shadow-lg">
              <h3 className="text-xl font-semibold mb-4 hover:transform"> Driving Course</h3>
              <p className="mb-4">
